...
def add_piece(game, player, row, column):
    ...
    """
    game[row][column] = player #column+1 changed to column
    return game
...
def switch_player(player):
    if player == 1: #double "=" instead of one
        return 2
    else:
        return 1
...
if __name__ == '__main__':
    ...
    while winner == 0 and moves_exist(game):
        ...
        while not available: #colon added
            ...
            available = check_space_empty(game, row, column) #column added as an argument
